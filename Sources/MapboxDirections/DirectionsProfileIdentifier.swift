...
public struct DirectionsProfileIdentifier: Codable, Hashable, RawRepresentable {
    ...
    */
    public static let automobile: DirectionsProfileIdentifier = .init(rawValue: "driving")
    ...
    */
    public static let automobileAvoidingTraffic: DirectionsProfileIdentifier = .init(rawValue: "driving-traffic")
    ...
    */
    public static let cycling: DirectionsProfileIdentifier = .init(rawValue: "cycling")
    ...
    */
    public static let walking: DirectionsProfileIdentifier = .init(rawValue: "walking")
	
	
	public static let cyclingRecreational: DirectionsProfileIdentifier = .init(rawValue: "cycling-recreational")
	
	public static let cyclingRacing: DirectionsProfileIdentifier = .init(rawValue: "cycling-race")
	public static let cyclingMountain: DirectionsProfileIdentifier = .init(rawValue: "cycling-mountain")
}
